		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
                ...
                @if ( Session::get('website_language') == 'en')
                    <form class="form-horizontal form-label-left" action="{{ route('Category.update',$cat_edit->id) }} "  method="POST" enctype="multipart/form-data">
    					...
    					<div class="item form-group">
    						...
    						<div class="col-md-8 col-sm-8 col-xs-12">
    							<input id="name" class="form-control col-md-7 col-xs-12 input_slug" value="{!! old('name',isset($cat_edit) ? $cat_edit->name : null) !!}"  data-validate-words="2" name="name" placeholder="Name category...." type="text">
    					...
    					<div class="item form-group">
    						...
    						<div class="col-md-8 col-sm-8 col-xs-12">
    							<input type="text" value="{!! old('slug',isset($cat_edit) ? $cat_edit->slug : null) !!}"  name="slug" class="form-control col-md-7 col-xs-12 output_slug" placeholder="slug - category ...">
    					...
    					<div class="item form-group">
    						...
    						<div class="col-md-8 col-sm-8 col-xs-12">
    	                         <select class="form-control" name="parent_id">
                                     <option value="0" selected=""> ==|| {{ trans('config.Category_Parent') }}</option>
                                    @foreach ($category as $cat)
                                        <option value="{!! $cat->id !!}" @if ($cat->id == $cat_edit->parent_id){{ 'selected' }}@endif> ==||==|| {{ $cat->name }}</option>
                                    @endforeach
    	                         </select>
                            </div>
    					</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12" >
                                    <a   style="height: 100%"  href="javascript:open_popup('{!!url('')!!}/assets/filemanager/dialog.php?type=1&popup=1&field_id=fieldID')" class="thumbnail">
                                        <img class="imagePreview" src="{!! url('') !!}/assets/upload/category/{{ $cat_edit->images }}" alt="">
                                    </a>
    							...
    							<div class="radio">
    	                            <label class="">
    	                              	<div class="iradio_flat-green checked" style="position: relative;">
                                            <input type="radio" class="flat" @if ($cat_edit->status == 1){{ 'checked' }}@endif value="1" name="status" style="position: absolute; opacity: 0;">
                         		...
                         		<div class="radio">
    	                            <label class="">
    	                              	<div class="iradio_flat-green checked" style="position: relative;">
                                            <input type="radio" value="0" @if ($cat_edit->status == 0){{ 'checked' }}@endif class="flat" name="status" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div> Un Checked
    	                            </label>
                         		</div>
    						</div>
    					</div>
                ...
                @else
                    <form class="form-horizontal form-label-left" action="{{ route('cat_edit_lang',$cat_edit->id) }}"  method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{!! csrf_token() !!}">
                      {{--   {{ method_field('PUT') }} --}}
                        <div class="item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <input id="name_vi" class="form-control col-md-7 col-xs-12 input_slug_vi" value="{!! old('name',isset($cat_edit) ? $cat_edit->name : null) !!}" name="name_vi" placeholder="Tên Danh Mục...." type="text">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <input type="text" value="{!! old('slug',isset($cat_edit) ? $cat_edit->slug : null) !!}"  name="slug_vi" class="form-control col-md-7 col-xs-12 output_slug_vi" placeholder="Link Danh mục ...">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                 <select class="form-control" name="category_id">
                                    @foreach ($category_lang as $cat)
                                        <option value="{!! $cat->category_id !!}" @if ($cat->category_id == $cat_edit->id) {{ 'selected' }}@endif > ==|| {{ $cat->name }}</option>
                                    @endforeach
                                 </select>
                                   <p><small>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <div class="radio">
                                    <label class="">
                                        <div class="iradio_flat-green checked" style="position: relative;"><input type="radio" value="1" class="flat" @if ($cat_edit->status == 1){{ 'checked' }}@endif name="status" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div> Sử Dụng
                                    </label>
                                </div>
                                <div class="radio">
                                    <label class="">
                                        <div class="iradio_flat-green checked" style="position: relative;"><input type="radio" value="0" @if ($cat_edit->status == 0){{ 'checked' }}@endif class="flat"  name="status" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div> Không Sử Dụng
                                    </label>
                                </div>
                            </div>
                        </div>
